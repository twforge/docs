...
Um beizutreten, klicke auf den Link und es öffnet sich ein Browserfenster, in dem du auf "beim Stammeskonstrukt bewerben" klicken musst.
...
Die Templatefunktion unter Aktionsplaner->Herkunftsdörfer benutzt immer nur die Dorftruppen, weshalb es notwendig ist, auch Verteidigung als Truppen hochzuladen, wenn du dieses Feature nutzen willst.
