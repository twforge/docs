...
Sobald du freigeschaltet bist, werden deine Berichte und Angriffe automatisch mit dem Stamm geteilt und du erhältst Zugriffsrechte, die dem dir von der SF zugewiesenen Rechtelevel entsprechen.
...
// Platzhalter, wofür ist Übersicht noch gut?
...
Über den Bereich *Beitrittsanfragen* werden alle offenen Anfragen von Spielern angezeigt, die über einen Invite Link dem Stammeskonstrukt beitreten möchten.
Für jede Anfrage werden der TW-Forge Account und der verknüpfte Ingame Account des Antragstellers angezeigt.
Anfragen können einzeln angenommen oder abgelehnt werden.

NOTE: Sobald mindestens eine offene Beitrittsanfrage vorliegt, wird über dem Menüpunkt eine Benachrichtigung eingeblendet.
...
Im Bereich *Truppen* können Stammestruppen eingelesen, aktualisiert und eingesehen werden.

=== Truppenübersicht

Nach dem Import werden die eingelesenen Truppen in einer tabellarischen Übersicht pro Stammesmitglied und Dorf angezeigt.
Die Übersicht ermöglicht es, den Truppenstand des gesamten Stammes auf einen Blick zu erfassen und gezielt nach einzelnen Spielern oder Dörfern zu filtern.
...
* im Aktionsplaner: xref:features/action-planner/overview.adoc[Aktionsplaner]
