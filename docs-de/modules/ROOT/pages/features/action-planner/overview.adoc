...
* *Anpassen der Ankunftszeit von geplanten Angriffen (AGs, Zwischencleaner) auf bereits laufende Befehle.

==== Anpassen mit Devilicious-Script

Um geplante Angriffe auf bereits laufende Angriffe anzugleichen, muss zunächst dass Develicious-SL-Script geladen werden. Dieses findest du link:https://forum.tribalwars.net/index.php?threads/devils-noble-spam-planner-enhancer.291222/[hier.]

So passt du deine Angriffe an:

. Kopiere die Zieldörfer aus der Checkbox in TW-Forge.
...
. Wenn alles richtig gemacht wird, siehst du bei jedem dorf, dass bei den letzten 3 roten Angriffen die ausgewählte AG-Anzahl eingefügt worden ist.
. Klicke auf "Extract Planning". Hierdurch wird unten im Textfeld ein Output generiert.
. Kopiere den gesamten Output (Strg A -> Strg C) und füge ihn in TW-Forge in das "Ankunftszeiten" Feld ein.
