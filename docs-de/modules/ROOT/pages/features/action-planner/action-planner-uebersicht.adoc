...
Wenn man mehrere verschiedene Off-, AG, Katter-, UT- oder Fakepläne erstellen möchte, können diese als Gruppen zusammengefasst werden, um die Übersichtlichkeit in der Planung selbst zu gewährleisten.
