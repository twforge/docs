...
Hier ist es z.B. sinnvoll, diese Pläne in eine Gruppe zu packen, um bei darauffolgenden Plänen, die Katapulte beinhalten, nicht die verplanten jedes einzelnen berechneten Plans abziehen zu müssen (mehr dazu unter Abhängigkeiten), sondern nur einmal die Plangruppe abziehen zu müssen. 
...
Wenn die Mitglieder jedoch über TW-Forge abschicken, wird der Parameter "alle" anhand der vom Account eingelesenn Truppen unter xref:features/account.adoc#account-truppen-einlesen[Account] bestimmt.
