...
// hier noch den Vorgang des Berechnens einbauen und nochmal das vorgehen überarbeiten, wenn alles gefixed ist

==== Berechnungsalgorithmen & Rechenkapazitäten image:badges/gold.png[TW-Forge-Gold,role=badge]
