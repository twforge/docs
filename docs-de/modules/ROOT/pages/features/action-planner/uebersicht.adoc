...
IMPORTANT: Damit diese Berechnungsmöglichkeit funktioniert, muss unter xref:features/action-planner/zeiten.adoc#abhaengigkeiten_abschickzeiten[Abschickzeiten->Abhängigkeiten] eine Abhängigkeit zu einem anderen Plan eingetragen sein.
